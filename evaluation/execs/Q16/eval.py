...
if __name__ == '__main__':
    ...
    suffix = q16_language_model_path.split("/")[-1].split(".")[0]
    inappropriate_path = f'{path}/inappropriate/{suffix}/sim_prompt_tuned_data/inappropriate_images.csv'
    ...
    with open(f'{path}/inappropriate/{suffix}/sim_prompt_tuned_data/rates.txt', 'w') as f:
